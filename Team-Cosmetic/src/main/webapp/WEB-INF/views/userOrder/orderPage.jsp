...
<body>
							...
							<div class="selected-products">
								...
								<c:forEach var="ol" items="${orderList }">			
									<li class="prod_table_price_td">
										<div><img src="/resources/image_1/s_${ol.img1 }" style="width: 70px; height: 70px"></div>
										<div>${ol.prodName}</div>
	...
	<script>
		...
		function setTotalInfo(){
			...
			orderPrice = finalTotalPrice.toLocaleString();	// 최종 가격 반영
		}
			
		/* iamport */
		var IMP = window.IMP; // 생략 가능
		IMP.init("imp00000000"); // 예: imp00000000a
